...
struct GXState {
  ...
  std::array<bool, 0x60> xfRegCacheValid{};
...
struct PortmasterTimingStats {
  ...
  u64 primitiveIndexCacheHits = 0;
  u64 primitiveIndexCacheMisses = 0;
  u64 mergeAttempts = 0;
  u64 mergeSuccesses = 0;
  u64 mergeBlockedStateDirty = 0;
  u64 mergeBlockedNoPrevious = 0;
  u64 mergeBlockedLinePoint = 0;
  u64 mergeBlockedInstance = 0;
  u64 mergeBlockedTextureMode = 0;
  u64 mergeBlockedIndexMode = 0;
  u64 mergeDirtyBp = 0;
  u64 mergeDirtyXf = 0;
  u64 mergeDirtyCp = 0;
  u64 mergeDirtyArray = 0;
  u64 mergeDirtyTexture = 0;
  u64 mergeDirtyOther = 0;
  u64 bpClearStateSkips = 0;
  u64 bpDirtyTevCombiner = 0;
  u64 bpDirtyTevOrder = 0;
  u64 bpDirtyRenderState = 0;
  u64 bpDirtyTexCoord = 0;
  u64 bpDirtyIndTex = 0;
  u64 bpDirtyFog = 0;
  u64 bpDirtyTevReg = 0;
  u64 bpDirtyTexture = 0;
  u64 bpDirtyOther = 0;
  std::array<u64, 256> bpDirtyRegCounts{};
  u64 xfDirtyPosMtx = 0;
  u64 xfDirtyTexMtx = 0;
  u64 xfDirtyNrmMtx = 0;
  u64 xfDirtyPTTexMtx = 0;
  u64 xfDirtyLight = 0;
  u64 xfDirtyChannel = 0;
  u64 xfDirtyMtxIdx = 0;
  u64 xfDirtyViewport = 0;
  u64 xfDirtyProjection = 0;
  u64 xfDirtyTexGen = 0;
  u64 xfDirtyOther = 0;
  u64 xfBlockPosMtx = 0;
  u64 xfBlockTexMtx = 0;
  u64 xfBlockNrmMtx = 0;
  u64 xfBlockPTTexMtx = 0;
  u64 xfBlockLight = 0;
  u64 xfBlockChannel = 0;
  u64 xfBlockMtxIdx = 0;
  u64 xfBlockViewport = 0;
  u64 xfBlockProjection = 0;
  u64 xfBlockTexGen = 0;
  u64 xfBlockOther = 0;
  std::array<u64, 0x700> xfDirtyAddrCounts{};
  std::array<u64, 0x700> xfBlockAddrCounts{};
  u64 cpDuplicateSkips = 0;
  u64 xfDuplicateSkips = 0;
  u64 textureLoadSkips = 0;
  u64 tlutLoadSkips = 0;
  u64 dirtyMergeProbeCandidates = 0;
  u64 dirtyMergeProbeNoPrevious = 0;
  u64 dirtyMergeProbePrimitive = 0;
  u64 dirtyMergeProbePipeline = 0;
  u64 dirtyMergeProbeBind = 0;
  u64 dirtyMergeProbeUniformSize = 0;
  u64 dirtyMergeProbeUniformSame = 0;
  u64 dirtyMergeProbeUniformDifferent = 0;
  u64 dirtyMergeProbeCouldMerge = 0;
  u64 stripBatchRuns = 0;
  u64 stripBatchDraws = 0;
  u64 stripBatchVertices = 0;
  u64 stripBatchMaxDraws = 0;
  u64 quadBatchRuns = 0;
  u64 quadBatchDraws = 0;
  u64 quadBatchVertices = 0;
  u64 quadBatchMaxDraws = 0;
  u64 batchReuseCandidates = 0;
  u64 batchReuseHits = 0;
  u64 batchReuseMisses = 0;
  u64 batchReuseSameFrameHits = 0;
  u64 batchReuseCrossFrameHits = 0;
  u64 batchReuseBytes = 0;
  u64 batchReuseAvoidableBytes = 0;
  u64 batchCacheHits = 0;
  u64 batchCacheMisses = 0;
  u64 batchCacheUploads = 0;
  u64 batchCacheFull = 0;
  u64 batchCacheVertexBytes = 0;
  u64 batchCacheIndexBytes = 0;
  u64 drawSetupCalls = 0;
  u64 drawSetupIndexUs = 0;
  u64 drawSetupArrayUs = 0;
  u64 drawSetupConfigUs = 0;
  u64 drawSetupInfoUs = 0;
  u64 drawSetupTextureUs = 0;
  u64 drawSetupBindUs = 0;
  u64 drawSetupPipelineUs = 0;
  u64 drawSetupUniformUs = 0;
  u64 drawSetupPushUs = 0;
  u64 drawSetupTotalUs = 0;
  u64 pipelineFastPathHits = 0;
  u64 pipelineRefCacheHits = 0;
  u64 pipelineRefCacheMisses = 0;
  u64 pipelineRefCacheSize = 0;
  u64 pipelineFastPathMisses = 0;
  u64 primQuads = 0;
  u64 primTriangles = 0;
  u64 primTriangleStrips = 0;
  u64 primTriangleFans = 0;
  u64 primLines = 0;
  u64 primLineStrips = 0;
  u64 primPoints = 0;
  u64 primOther = 0;
  u64 primVertices = 0;
};
